...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank"  rel="noopener">Docs</a>
            </li>
            <li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank"  rel="noopener">Community</a></li>
            <li class="menu-item hidden"><a
                    href="https://github.com/codeigniter4/CodeIgniter4/blob/develop/CONTRIBUTING.md" target="_blank"  rel="noopener">Contribute</a>
            </li>
        </ul>
    </div>
...
<div class="further">
    ...
    <section>
        ...
        <p>CodeIgniter is a community-developed open source project, with several
             ...
             target="_blank"  rel="noopener">CodeIgniter's forum</a>, or <a href="https://codeigniterchat.slack.com/"
